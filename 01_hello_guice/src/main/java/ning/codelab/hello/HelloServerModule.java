 ...
 * and configure what is needed for the hello core. See <a
 * href=http://code.google
 * .com/p/google-guice/>http://code.google.com/p/google-guice/</a> for more
 * information on Google Guice.
 */
public class HelloServerModule extends AbstractModule {
	protected void configure() {
		 ...
		 */
		// Adding the DateTime Converter to hte config module for handling
		// DateTime objects.
